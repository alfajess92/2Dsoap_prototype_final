...
public class Demo : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyUp(KeyCode.S))
        {
            ...
            ageQuantity = 30;
            strenghtCoins = 300.5f;
            has_sword = true;
            skills = new int[] { 6, 10, 22, 46, 69 };

            myFile.Add("age", ageQuantity);
            myFile.Add("strenght", strenghtCoins);
        ...
        if (Input.GetKeyUp(KeyCode.L))
        {
            ...
            if (myFile.Load())
            {
                ...
                ageQuantity = myFile.GetInt("age");
                strenghtCoins = myFile.GetFloat("strenght");
                ...
                nicknameItem = myFile.GetString("nickname", "user_1234");
    ...
    private void ShowData()
    {
        ...
        Debug.Log("Nickname: " + nicknameItem + "\n");
        Debug.Log("Age: " + ageQuantity + "\n");
